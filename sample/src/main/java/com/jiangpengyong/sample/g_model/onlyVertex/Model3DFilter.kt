package com.jiangpengyong.sample.g_model.onlyVertex
...
class Model3DProgram : GLProgram() {
    ...
    override fun getVertexShaderSource(): String = loadFromAssetsFile(EGLBoxRuntime.context.resources, "glsl/model/vertex_and_light/vertex.glsl")

    override fun getFragmentShaderSource(): String = loadFromAssetsFile(EGLBoxRuntime.context.resources, "glsl/model/vertex_and_light/fragment.glsl")
}
