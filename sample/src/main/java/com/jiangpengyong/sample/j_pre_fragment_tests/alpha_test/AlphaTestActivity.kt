 ...
 * @date 2025/1/20 23:39
 * @email 56002982@qq.com
 * @des alpha 测试
 */
class AlphaTestActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        FilterCenter.registerFilter(AlphaTestFilter.TAG, AlphaTestFilter::class.java)
        ...
        glPreviewView.post {
            ...
            filterId = glPreviewView.addFilter(AlphaTestFilter.TAG)
