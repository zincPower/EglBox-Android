...
class SpecularLightBallProgram : GLProgram() {
    ...
    override fun getVertexShaderSource(): String = loadFromAssetsFile(App.context.resources, "glsl/specular_light/vertex.glsl")

    override fun getFragmentShaderSource(): String = loadFromAssetsFile(App.context.resources, "glsl/specular_light/fragment.glsl")
