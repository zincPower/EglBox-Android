 ...
 * @des 绘制球 —— 环境光
 */
class AmbientLightBallProgram : GLProgram() {
    ...
    override fun getVertexShaderSource(): String = loadFromAssetsFile(App.context.resources, "glsl/light/ambient/vertex.glsl")

    override fun getFragmentShaderSource(): String = loadFromAssetsFile(App.context.resources, "glsl/light/ambient/fragment.glsl")
}
