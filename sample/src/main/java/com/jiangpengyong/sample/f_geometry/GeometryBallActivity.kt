...
import com.jiangpengyong.sample.f_geometry.geometry.filter.GeometryBallFilter
 ...
 * @des 几何球
 */
class GeometryBallActivity : AppCompatActivity() {
    companion object {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_geometry_geometry_ball)
    ...
    class RenderView : GLSurfaceView {
        ...
        private class Renderer : GLSurfaceView.Renderer {
            private val mFilterId = "GeometryBallFilter"
            private val mFilter = GeometryBallFilter().apply { id = mFilterId }
