 ...
 * @date 2024/12/2 08:20
 * @email 56002982@qq.com
 * @des 地球云
 */
class EarthCloudProgram : GLProgram() {
    ...
    override fun getVertexShaderSource(): String = loadFromAssetsFile(App.context.resources, "glsl/texture/earth_cloud/vertex.glsl")

    override fun getFragmentShaderSource(): String = loadFromAssetsFile(App.context.resources, "glsl/texture/earth_cloud/fragment.glsl")
}
