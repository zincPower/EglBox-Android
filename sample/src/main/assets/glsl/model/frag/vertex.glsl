...
// 是否顶点着色器进行计算光照
uniform int uIsVertexCalculateLighting;
...
out vec3 vNormal;
// 双面计算
out int vIsDoubleSideRendering;
// 光照计算方式
out int vIsVertexCalculateLighting;
...
void main() {
    ...
    vIsVertexCalculateLighting = uIsVertexCalculateLighting;
    vIsDoubleSideRendering = uIsDoubleSideRendering;
